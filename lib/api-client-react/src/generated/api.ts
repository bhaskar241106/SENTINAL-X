...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCountryLawsQueryKey(code);
   ...
   return  { queryKey, queryFn, enabled: code !== null && code !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCountryLaws>>, TError, TData> & { queryKey: QueryKey }
}
...
export const calculateChallan = async (challanInput: ChallanInput, options?: RequestInit): Promise<ChallanResult> => {
  ...
  return customFetch<ChallanResult>(getCalculateChallanUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(challanInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEmergencyContactsQueryKey(countryCode);
   ...
   return  { queryKey, queryFn, enabled: countryCode !== null && countryCode !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getEmergencyContacts>>, TError, TData> & { queryKey: QueryKey }
}
...
export const analyzeSentinelRisk = async (sentinelInput: SentinelInput, options?: RequestInit): Promise<SentinelRiskAnalysis> => {
  ...
  return customFetch<SentinelRiskAnalysis>(getAnalyzeSentinelRiskUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(sentinelInput)
  }
);}
...
export const reportAccident = async (accidentInput: AccidentInput, options?: RequestInit): Promise<AccidentRecord> => {
  ...
  return customFetch<AccidentRecord>(getReportAccidentUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(accidentInput)
  }
);}
